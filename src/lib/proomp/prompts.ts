...
export const generateInterviewQuestion = (jobOffer: string) => {
  ...
  const systemPrompt = "Extract the relevant information from the job offer list the soft and hard skills needed to succeed in said position.";
...
export const validateAnswer = (interviewData: InterviewData, history: ChatCompletionMessageParam[], skill: string, question: string, answer: string) => {
